...
sys.path.insert(0, '.')
sys.path.insert(0, '..')
from dkb_robo.transaction import Transactions, AccountTransactionItem, CreditCardTransactionItem, DepotTransactionItem
...
class TestTransactions(unittest.TestCase):
    ...
    def test_018_get(self, mock_fetch, mock_filter, mock_correlate, mock_aformat, mock_creditformat, mock_depotformat):
        ...
        mock_depotformat.return_value = 'mock_depotformat'
        mock_filter.return_value = [{'id': 'id', 'attributes': {'mock_filter': 'mock_filter'}}]
        mock_correlate.return_value = [{'id': 'id', 'attributes': {'mock_correlate': 'mock_correlate'}}]
    ...
    def test_019_map(self):
        ...
        result = {'attributes': {'performance': {'currentValue': {'value': 1000}}, 'lastOrderDate': '2020-01-01', 'quantity': {'value': 1000, 'unit': 'unit'}, 'instrument': {'identifiers': [{'identifier': 'isin', 'value': 'value'}, {'identifier': 'isin', 'value': 'value2'}], 'name': {'short': 'short'}, 'id': 'inid'}, 'quote': {'identifiers': [{'identifier': 'isin', 'value': 'value'}, {'identifier': 'isin', 'value': 'value2'}], 'name': {'short': 'short'}, 'id': 'inid'}}, 'relationships': {'instrument': {'data': {'id': 'inid'}}, 'quote': {'data': {'id': 'inid', 'value': 'value'}}}}
    ...
    def test_020_map(self):
        ...
        result = {'attributes': {'performance': {'currentValue': {'value': 1000}}, 'lastOrderDate': '2020-01-01', 'quantity': {'value': 1000, 'unit': 'unit'}, 'instrument': {'identifiers': [{'identifier': 'isin', 'value': 'value'}, {'identifier': 'isin', 'value': 'value2'}], 'name': {'short': 'short'}, 'id': 'inid'}}, 'relationships': {'instrument': {'data': {'id': 'inid'}}, 'quote': {'data': {'id': 'quoteid', 'value': 'value'}}}}
        self.assertEqual(result, self.transaction._map(data_dic, included_list))
    ...
    def test_021_map(self):
        """ test _details() - add instrument information """
        included_list = [{'id': 'inid', 'attributes': {'identifiers': [{'identifier': 'isin', 'value': 'value'}, {'identifier': 'isin', 'value': 'value2'}], 'name': {'short': 'short'}}}]
        data_dic = {'attributes': {'performance': {'currentValue': {'value': 1000}}, 'lastOrderDate': '2020-01-01', 'quantity': {'value': 1000, 'unit': 'unit'}}, 'relationships': {'instrument': {'data': {'id': 'inid1'}}, 'quote': {'data': {'id': 'inid', 'value': 'value'}}}}
        result = {'attributes': {'performance': {'currentValue': {'value': 1000}}, 'lastOrderDate': '2020-01-01', 'quantity': {'value': 1000, 'unit': 'unit'}, 'quote': {'identifiers': [{'identifier': 'isin', 'value': 'value'}, {'identifier': 'isin', 'value': 'value2'}], 'name': {'short': 'short'}, 'id': 'inid'}}, 'relationships': {'instrument': {'data': {'id': 'inid1'}}, 'quote': {'data': {'id': 'inid', 'value': 'value'}}}}
        self.assertEqual(result, self.transaction._map(data_dic, included_list))
...
class TestAccountTransactionItem(unittest.TestCase):
    def setUp(self):
        ...
        self.creditor_data = {
            'creditorAccount': {'iban': 'DE1234567890', 'bic': 'BICCODE', 'id': 'creditor_id', 'name': 'Creditor Name', 'intermediaryName': 'credintermediaryName'},
            'agent': {'bic': 'BICCODE'},
            'id': 'creditor_id',
            'name': 'Creditor Name'
        }
        self.debtor_data = {
            'debtorAccount': {'iban': 'DE0987654321', 'bic': 'BICCODE1', 'id': 'debtor_id', 'name': 'Debtor Name', 'intermediaryName': 'debintermediaryName'},
            'agent': {'bic': 'BICCODE1'},
            'id': 'debtor_id',
            'name': 'Debtor Name'
        }
    ...
    def test_028_peer_information(self, mock_logger):
        ...
        self.amount_data = {'value': 100, 'currencyCode': 'USD'}
        self.creditor_data = {
            'creditorAccount': {'iban': 'DE1234567890', 'bic': 'BICCODE', 'id': 'creditor_id', 'name': 'Creditor Name'},
            'agent': {'bic': 'BICCODE'},
            'id': 'creditor_id',
            'name': 'Creditor Name'
        }
        self.debtor_data = {
            'debtorAccount': {'iban': 'DE0987654321', 'bic': 'BICCODE1', 'id': 'debtor_id', 'name': 'Debtor Name'},
            'agent': {'bic': 'BICCODE1'},
            'id': 'debtor_id',
            'name': 'Debtor Name',
        ...
        result = {'debtorAccount': {'iban': 'DE0987654321', 'bic': 'BICCODE1', 'id': 'debtor_id', 'name': 'Debtor Name', 'intermediaryName': 'debintermediaryName'}, 'agent': {'bic': 'BICCODE1'}, 'id': None, 'bic': None, 'name': None, 'intermediaryName': 'debintermediaryName'}
        transaction = AccountTransactionItem(**self.transaction_data1)._peer_information(peer_dic={'debtor': self.debtor_data}, peer_type='debtor')
...
class TestCreditCardTransactionItem(unittest.TestCase):
    ...
    @patch('dkb_robo.transaction.Amount', autospec=True)
    @patch('dkb_robo.transaction.CreditCardTransactionItem.MerchantCategory', autospec=True)
...
class TestDepotTransactionItem(unittest.TestCase):
    def setUp(self):
        ...
        self.performance_data = {'currentValue': {'value': 150.0, 'currencyCode': 'EUR'}, 'isOutdated': False}
        self.quote_data = {'id': 'quote123', 'market': 'market1', 'price': {'value': 150.0, 'currencyCode': 'EUR'}, 'timestamp': '2022-01-15'}
        self.transaction_data = {
            'id': 'trans123',
    ...
    def test_036_post_init(self, MockQuote, MockPerformance, MockInstrument, MockCustody, MockQuantity, MockPerformanceValue):
    ...
    def test_037_post_init(self):
        ...
        self.assertEqual(transaction.custody.characteristic.characteristicType, 'charType')
