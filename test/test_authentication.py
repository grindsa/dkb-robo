...
class TestAuthentication(unittest.TestCase):
    ...
    def test_007_init_invalid_session_backend(self):
    ...
    def test_008__session_new_curl_backend(self):
    ...
    def test_009__session_new(self, mock_session):
        """test _session_new()"""
    ...
    @patch("requests.session")
    def test_010__session_new(self, mock_session):
        """test _session_new()"""
    ...
    @patch("requests.session")
    def test_011__session_new(self, mock_session):
        """test _session_new()"""
        self.auth.session_backend = "requests"
        mock_session.return_value.headers = {}
    ...
    @patch("requests.session")
    def test_012__session_new_assigns_headers(self, mock_session):
        """test _session_new() assigns provided headers to client"""
        self.auth.session_backend = "requests"
        mock_session.return_value.cookies = {}
        headers = {"Accept": "application/json"}

        client = self.auth._session_new(headers=headers)

        self.assertEqual(headers, client.headers)

    def test_013__session_new_curl_backend_import_error(self):
    ...
    def test_016_token_get_xvfb(self):
    ...
    def test_017_token_get_retries_once_on_csrf_403(self):
    ...
    def test_018_token_get_403_without_csrf_does_not_retry(self):
    ...
    def test_019_sync_csrf_header_uses_host_xsrf_cookie(self):
    ...
    def test_020_sync_csrf_header_uses_fallback_cookie(self):
    ...
    def test_021_sync_csrf_header_no_token_no_change(self):
    ...
    def test_022_sync_csrf_header_cookies_error_no_change(self):
    ...
    def test_023_sync_csrf_header_headers_fallback_assignment(self):
    ...
    def test_024_token_get(self, mock_captcha):
    ...
    @patch("requests.session")
    def test_040__mfa_challenge(self, mock_session):
        """test _mfa_challenge()"""
        mfa_dic = {}
        with self.assertLogs("dkb_robo", level="INFO") as lcm:
    ...
    @patch("requests.session")
    def test_041__mfa_challenge(self, mock_session):
        """test _mfa_challenge()"""
        self.auth.client = Mock()
        self.auth.client.headers = {}
        self.auth.client.post.return_value.status_code = 200
    ...
    @patch("requests.session")
    def test_042__mfa_challenge(self, mock_session):
        """test _mfa_challenge()"""
        self.auth.client = Mock()
        self.auth.client.headers = {}
        self.auth.client.post.return_value.status_code = 400
    ...
    @patch("requests.session")
    def test_043__mfa_challenge(self, mock_session):
        """test _mfa_challenge()"""
        self.auth.client = Mock()
        self.auth.client.headers = {}
        self.auth.client.post.return_value.status_code = 200
    ...
    def test_044__mfa_finalize(self, mock_cid, mock_app, mock_ctm):
        """test _mfa_finalize()"""
    ...
    @patch("dkb_robo.authentication.APPAuthentication.finalize")
    @patch("dkb_robo.authentication.Authentication._mfa_challenge_id")
    def test_045__mfa_finalize(self, mock_cid, mock_app, mock_ctm):
        """test _mfa_finalize()"""
        mock_cid.return_value = "cid"
        mock_app.return_value = "app"
        mock_ctm.return_value = "ctm"
    ...
    @patch("dkb_robo.authentication.APPAuthentication.finalize")
    @patch("dkb_robo.authentication.Authentication._mfa_challenge_id")
    def test_046__mfa_finalize(self, mock_cid, mock_app, mock_ctm):
        """test _mfa_finalize()"""
        mock_cid.return_value = "cid"
        mock_app.return_value = "app"
        mock_ctm.return_value = "ctm"
    ...
    @patch("requests.session")
    def test_047__mfa_challenge_id(self, mock_session):
    ...
    @patch("requests.session")
    def test_048__mfa_challenge_id(self, mock_session):
        """test _mfa_challenge_id()"""
    ...
    def test_051__token_update(self):
    ...
    def test_052__device_data_send(self):
        ...
        self.assertNotIn("Content-Type", self.auth.client.headers)
        self.assertNotIn("Accept", self.auth.client.headers)

    def test_053__device_data_send(self):
    ...
    @patch("dkb_robo.authentication.get_dkb_redeem_token")
    def test_057_login(self, _mock_captcha, mock_sess, mock_tok, mock_meth, mock_sort):
        """test login()"""
        self.auth.token_dic = {"foo": "bar"}
    ...
    @patch("dkb_robo.authentication.get_dkb_redeem_token")
    def test_058_login(
        self, _mock_captcha, mock_sess, mock_tok, mock_meth, mock_mfa, mock_sort
    ):
        """test login()"""
        self.auth.token_dic = {"mfa_id": "mfa_id"}
        mock_meth.return_value = {"foo": "bar"}
    ...
    def test_065_logout(self):
        """test logout"""
        self.assertFalse(self.auth.logout())

    def test_066_logout_closes_client_and_clears_reference(self):
    ...
    def test_067_logout_handles_close_exception_and_clears_reference(self):
...
class TestAPPAuthentication(unittest.TestCase):
    ...
    def test_073__print(self, mock_stdout):
    ...
    @unittest.mock.patch("sys.stdout", new_callable=io.StringIO)
    def test_074__print(self, mock_stdout):
        """test _print_app_2fa_confirmation()"""
    ...
    def test_075_finalize(self, mock_confirm, mock_status, _mock_sleep):
        """test _mfa_finalize()"""
    ...
    @patch("dkb_robo.authentication.APPAuthentication._check")
    @patch("dkb_robo.authentication.APPAuthentication._print")
    def test_076_finalize(self, mock_confirm, mock_status, _mock_sleep):
        """test _mfa_finalize()"""
        self.appauth.client = Mock()
        self.appauth.client.headers = {}
...
class TestTANAuthentication(unittest.TestCase):
    ...
    def test_077__print(self, mock_show):
        """test _print()"""
        challenge_dic = {}
    ...
    def test_078__print(self, mock_input, mock_show, mock_stdout):
        """test _print()"""
        challenge_dic = {
            "data": {
                "attributes": {
    ...
    @patch("dkb_robo.authentication.TANAuthentication._image")
    @patch("builtins.input")
    def test_079__print(self, mock_input, mock_show, mock_stdout):
        """test _print()"""
        challenge_dic = {
            "data": {
                "attributes": {
    ...
    @patch("dkb_robo.authentication.TANAuthentication._print")
    def test_082_finalize(self, mock_ctan):
        """test finalize()"""
        mock_ctan.return_value = "ctan"
        self.tanauth.client = Mock()
        self.tanauth.client.headers = {}
    ...
    @patch("dkb_robo.authentication.TANAuthentication._print")
    def test_083_finalize(self, mock_ctan):
        """test finalize()"""
        mock_ctan.return_value = "ctan"
        self.tanauth.client = Mock()
        self.tanauth.client.headers = {}
